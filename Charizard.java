...
/**
 * Charizard Pokemon object class. subclass of Charmeleon 
...
public class Charizard extends Charmander implements FlyingType {
	 ...
	 */
	protected Charizard(String species, String name, int num, double ht, double wt, int baseAttackPwr,
	 ...
	 * attack type is fire or Flying Randomly picks an attack from type interface
	 * attack arrays
	 */
	...
	public String performFastAttack(Pokemon victim) {
		...
		if (fastIsFire) { // if attack is Fire-type
			...
			} else if (vType.equals("Dragon") || vType.equals("Fire") || vType.equals("Rock")
					|| vType.equals("Water")) {
				s = s + "\n It was not very effective.";
				modifier = modifier * 0.5;
			}
		} else { // is Flying attack
			if (vType.equals("Bug") || vType.equals("Fight") || vType.equals("Grass")) {
				s = s + "\n It was super effective!";
				modifier = modifier * 2.0;
