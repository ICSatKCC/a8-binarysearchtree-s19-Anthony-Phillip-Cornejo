...
/**
 * Bulbasaur Pokemon object class. Dual-type Grass|Poison implements two type
...
public class Bulbasaur extends Pokemon implements GrassType, PoisonType {
	...
	/**
	 * Constructor with no name. uses Pokemon superclass constructor attacks must be
	 * set after contruction of Pokemon Object because of dependence on type
	 * interface
	 */
	public Bulbasaur() {
		super("Bulbasaur", "Bulbasaur", 1, GRASS_COLOR, 0.71, 6.9, GRASS_TYPE, POISON_TYPE, BASE_ATTACK_POWER,
	...
	/**
	 * Constructor with name. uses Pokemon superclass constructor attacks must be
	 * set after contruction of Pokemon Object because of dependence on type
	 * interface
	 * 
	...
	public Bulbasaur(String name) {
		super("Bulbasaur", name, 1, GRASS_COLOR, 0.71, 6.9, GRASS_TYPE, POISON_TYPE, BASE_ATTACK_POWER,
				BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
		// pick Attacks
		chooseFastAttack();
		chooseSpecialAttack();
	 ...
	 */
	protected Bulbasaur(String species, String name, int num, double ht, double wt, int baseAttackPwr,
			int baseDefensePwr, int baseStaminaPwr) {

		super(species, name, num, GRASS_COLOR, ht, wt, GRASS_TYPE, POISON_TYPE, baseAttackPwr, baseDefensePwr,
				baseStaminaPwr);
		// pick Attacks
	...
	/**
	 * Grass|Poison-type specific fast attack chooser. Randomly picks whether attack
	 * type is grass or poison Randomly picks an attack from type attack arrays
	 */
	 ...
	 * attack type is grass or poison Randomly picks an attack from type interface
	 * attack arrays
	 */
	...
	public String performFastAttack(Pokemon victim) {
		...
		if (fastIsGrass) { // if attack is grass-type
			...
			} else if (vType.equals("Rock") || vType.equals("Ghost") || vType.equals("Ground")
					|| vType.equals("Poison")) {
				s = s + "\n It was not very effective.";
				modifier = modifier * 0.5;
	...
	/**
	 * Game-play special attack simulation. Creates an output String stating attack
	 * details checks for weakness/strength adjustment based on victim Pokemon's
	 * type and attack type (only need to check latter for dual-type) uses Damage
	 * formula from here: http://bulbapedia.bulbagarden.net/wiki/Damage Calls
	 * beAttacked method on attacked victim.
	 * 
	 * @param victim the Pokemon being attacked.
	 * @return String explaining attack and effectiveness.
	...
	/**
	 * Reduces Pokemon's HP by damage/defensePower. Doesn't allow HP to go less than
	 * 0 Implementation of "fainting" not done here
	 * 
